        ...
        <div class="container position-relative">
            <div class="site-navigation text-center">
                <a href="{{ route('home') }}" class="logo menu-absolute m-0">
                    <img src="{{ asset('images/logo.png') }}" alt="Logo" class="logo logo-img img-fluid" width="30" height="15">
                </a>
                ...
                <a href="{{ route('contact-us') }}" class="btn-book btn btn-secondary btn-sm menu-absolute">Contact Us</a>
